...
def test_ranking_type_shape() -> None:
    ...
    strength = StrengthWithEvidence(
        skill_or_trait="Python", resume_evidence_quote="Built APIs in Python."
    )
    gap = GapOrRisk(
        missing_requirement="SQL", impact="Moderate", uncertainty_hint="Ask about db experience."
    )
